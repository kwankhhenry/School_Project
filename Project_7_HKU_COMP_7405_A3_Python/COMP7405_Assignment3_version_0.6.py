...
def action6(testcase):
    if testcase == '1':
        # Put Options #1
        print ("Arithmetic Basket Put Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 0))
        # Put Options #2
        print ("Arithmetic Basket Put Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.9, CallPutSwitch = 'p', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.9, CallPutSwitch = 'p', M = 100000, Control = 0))
        # Put Options #3
        print ("Arithmetic Basket Put Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.1, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.1, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 0))
        # Put Options #4
        print ("Arithmetic Basket Put Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 80, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 80, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 0))
        # Put Options #5
        print ("Arithmetic Basket Put Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 120, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 120, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 0))
        # Put Options #6
        print ("Arithmetic Basket Put Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.5, sigma2 = 0.5, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.5, sigma2 = 0.5, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 0))

        # Call Options #1
        print ("Arithmetic Basket Call Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 0))
        # Call Options #2
        print ("Arithmetic Basket Call Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.9, CallPutSwitch = 'c', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.9, CallPutSwitch = 'c', M = 100000, Control = 0))
        # Call Options #3
        print ("Arithmetic Basket Call Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.1, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.1, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 0))
        # Call Options #4
        print ("Arithmetic Basket Call Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 80, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 80, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 0))
        # Call Options #5
        print ("Arithmetic Basket Call Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 120, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 120, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 0))
        # Call Options #6
        print ("Arithmetic Basket Call Option w/o variate (S1 = 100, S2 = 100, sigma1 = 0.5, sigma2 = 0.5, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 0)")
        print (ArithmeticBasketOption(S1 = 100, S2 = 100, sigma1 = 0.5, sigma2 = 0.5, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 0))

        # With Control Variates
        # Put Options #7
        print ("Arithmetic Basket Put Option with variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 1)")
        ...
        # Put Options #8
        print ("Arithmetic Basket Put Option with variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.9, CallPutSwitch = 'p', M = 100000, Control = 1)")
        ...
        # Put Options #9
        print ("Arithmetic Basket Put Option with variate (S1 = 100, S2 = 100, sigma1 = 0.1, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 1)")
        ...
        # Put Options #10
        print ("Arithmetic Basket Put Option with variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 80, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 1)")
        ...
        # Put Options #11
        print ("Arithmetic Basket Put Option with variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 120, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 1)")
        ...
        # Put Options #12
        print ("Arithmetic Basket Put Option with variate (S1 = 100, S2 = 100, sigma1 = 0.5, sigma2 = 0.5, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'p', M = 100000, Control = 1)")
        ...
        # Call Options #13
        print ("Arithmetic Basket Call Option with variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 1)")
        ...
        # Call Options #14
        print ("Arithmetic Basket Call Option with variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.9, CallPutSwitch = 'c', M = 100000, Control = 1)")
        ...
        # Call Options #15
        print ("Arithmetic Basket Call Option with variate (S1 = 100, S2 = 100, sigma1 = 0.1, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 1)")
        ...
        # Call Options #16
        print ("Arithmetic Basket Call Option with variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 80, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 1)")
        ...
        # Call Options #17
        print ("Arithmetic Basket Call Option with variate (S1 = 100, S2 = 100, sigma1 = 0.3, sigma2 = 0.3, r = 0.05, T = 3.0 ,K = 120, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 1)")
        ...
        # Call Options #18
        print ("Arithmetic Basket Call Option with variate (S1 = 100, S2 = 100, sigma1 = 0.5, sigma2 = 0.5, r = 0.05, T = 3.0 ,K = 100, p = 0.5, CallPutSwitch = 'c', M = 100000, Control = 1)")
        ...
        if testcase == '2':
            ...
            M = np.int(input('M = ? '))
            Control = np.int(input('Control = ? (0 / 1) '))
            print("Answer: %s" % ArithmeticMeanBasket(S1, S2, sigma1, sigma2, r, T, K, p, CallPutSwitch, M, Control))
            print("\n")    
##########################################################################
#Task 6
